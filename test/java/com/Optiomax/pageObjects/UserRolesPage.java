...
public class UserRolesPage extends BasePage {
    ...
    private By addNewUserRoleClose = By.xpath("/html/body/main/div/div/main/div/div/div[1]/div/div/div[2]/div[3]/div[2]/div[1]/a");
    ...
    public void clickAddNewUserRoleClose() {
        driver.findElement(addNewUserRoleClose).click();
    }
